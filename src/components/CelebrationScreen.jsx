    ...
    <div className="h-screen w-screen bg-gradient-to-b from-green-100 to-green-50 flex items-center justify-center p-6 relative overflow-hidden fixed inset-0">
      ...
      <div className="text-center relative z-10">
        ...
        <div className="relative mb-8">
          <div className="w-72 h-72 bg-green-200 rounded-full flex items-center justify-center mx-auto shadow-2xl animate-bounce relative">
            {/* Inner glow effect */}
        ...
        {/* Celebration message */}
        <h2 className="text-4xl font-black text-gray-800 animate-pulse px-4">
          {message}
        </h2>
      </div>
    </div>
